            ...
            <div className="container p-8">
                ...
                <div className="lg:grid lg:grid-cols-[1.5fr,1fr] gap-8">
                    ...
                    <div className="mt-8 lg:m-0">
                        <button className="border-4 border-black shadow-md p-4 rounded-xl text-xl font-semibold mb-4 flex flex-row gap-4 items-center lg:hover:underline">Autogiro <FiDownload /></button>
                        <button className="border-4 border-black shadow-md p-4 rounded-xl text-xl font-semibold mb-4 flex flex-row gap-4 items-center lg:hover:underline">Andrahandsuthyrning <FiDownload /></button>
                    </div>
                </div >
            </div >
        </div >
