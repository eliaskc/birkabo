        ...
        <div className="container mb-16 grid grid-cols-1 justify-items-center gap-y-8 px-8 lg:mb-16 lg:grid-cols-4 lg:grid-rows-[2.5fr,1fr] lg:gap-8 lg:gap-y-16 lg:p-0 lg:py-8">
            ...
            {links.map((link) => (
                <Link key={link.href} href={link.href} className="w-full">
                    <button
                        type="button"
                        className="h-24 w-full break-all rounded-2xl bg-white px-4 text-xl font-bold shadow-md duration-300 hover:shadow-xl lg:row-start-2 lg:h-32 lg:shadow-lg lg:hover:scale-105"
                    >
                        {link.label}
                    </button>
                </Link>
