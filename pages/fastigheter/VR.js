...
export default function VR() {
    ...
    var estateDescription =
        <p>
            ...
            <span className="font-medium">Antal lägenheter:</span> 25 + 1 lokal <br />
            <span className="font-medium">Lägenhetsstorlekar:</span> 1 rok på 36 m<sup>2</sup> & 4 rok på 108 m<sup>2</sup> <br />
            <span className="font-medium">Parkeringsplatser & Garage:</span> Finns <br />
